...
startup
{
    vars.Log = (Action<object>)(output => print("[Baby Steps] " + output));
...
init
{
    vars.gameInProgress = vars.Helper.Make<bool>("CoreGameLogic", "Menu", 0, "me", "gameInProgress");
...
start
{
    return vars.gameInProgress.Old == false && vars.gameInProgress.Current == true;
}
