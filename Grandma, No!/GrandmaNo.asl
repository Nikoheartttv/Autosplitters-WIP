state("GrandmaNo-Win64-Shipping") { }
...
init
{
    ...
    // GEngine.GameInstance.QuestManager
    
    // GEngine.GameInstance.LocalPlayers[0].AcknowledgedPawn.IsPaused
    vars.Helper["TransitionType"] = vars.Helper.Make<int>(gEngine, 0xBBB);
...
isLoading
{
	return current.PauseLocked || current.TransitionType == 1;
}